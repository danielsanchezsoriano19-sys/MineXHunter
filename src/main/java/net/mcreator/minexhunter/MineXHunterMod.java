package net.mcreator.minexhunter;
...
@Mod("mine_x_hunter")
public class MineXHunterMod {
	public static final Logger LOGGER = LogManager.getLogger(MineXHunterMod.class);
	public static final String MODID = "mine_x_hunter";

	public MineXHunterMod(FMLJavaModLoadingContext context) {
