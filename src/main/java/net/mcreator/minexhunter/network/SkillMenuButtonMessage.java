...
public record SkillMenuButtonMessage(int buttonID, int x, int y, int z) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		MineXHunterMod.addNetworkMessage(SkillMenuButtonMessage.class, SkillMenuButtonMessage::buffer, SkillMenuButtonMessage::new, SkillMenuButtonMessage::handler);
	}
}