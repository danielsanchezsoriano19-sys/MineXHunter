...
import net.mcreator.minexhunter.procedures.SkillMenuZoldyickKeyOnKeyPressedProcedure;
...
public class SkillMenuZoldyickKeyMessage {
	...
	public static void pressAction(Player entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SkillMenuZoldyickKeyOnKeyPressedProcedure.execute(world, x, y, z, entity);
		}
	}
